...
badchar: generate bad characters (I don't have this memorized)
...
class module():
  ...
  def __init__(self, static_args, dynamic_args):
    ...
    self.r = standard_bin(self.bytes, False)
    self.e = standard_bin(self.bytes, True)
